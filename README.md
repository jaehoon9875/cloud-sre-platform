...
![Grafana GKE Spot Exporter Dashboard](docs/images/grafana-spot-exporter.png)

![Grafana FinOps Dashboard](docs/images/grafana-finops.png)

![Slack 비용 리포트](docs/images/slack-cost-report.png)
